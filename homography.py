...
def Inverse2x2(mat, inv):
 
    det = float(mat[0]*mat[3] - mat[1]*mat[2]) 
...
def Eigen2by2Sym(Matrix, eigenvalue, eigenvectors):
 
    #  a, b, c 
    #  B, C 
    #  e1, e2 

    a=Matrix[0],  c=Matrix[1],  b=Matrix[3] 
    B=-a-b 
    C=a*b-c*c 
